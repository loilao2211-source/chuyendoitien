  ...
  async getGoldPrice(quote = 'USD') {
    ...
    try {
      ...
      try {
        ...
        if (yahooResponse.ok) {
          ...
          if (currentPrice && currentPrice > 0) {
            ...
            if (normalized.isValid) {
              console.log('[metals] Using Yahoo Finance XAU price:', currentPrice);
              return {
                quote,
        ...
        console.warn('[metals] Yahoo Finance failed:', yahooError.message);
      }
      ...
      console.error('[metals] API error, using fallback:', error.message);
