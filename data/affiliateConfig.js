...
export const affiliateConfig = {
  ...
  crypto: [
    ...
    },
    {
      ...
      description: 'Bảo quản tài sản số an toàn với TrustWallet',
      fee: 'Miễn phí tải về',
      cta: 'Tải ví',
      href: '/go/trustwallet',
      outboundHref: 'https://trustwallet.com',
      badge: 'Phổ biến',
      icon: '🔐',
    },
    {
      id: 'crypto-wallet-hardware',
      name: 'Ví cứng (Hardware)',
      description: 'Bảo mật cấp cao với Ledger',
      fee: 'Từ $79',
      cta: 'Xem ví cứng',
      href: '/go/ledger',
      outboundHref: 'https://ledger.com',
      badge: 'An toàn hơn',
      icon: '🔒',
    },
    {
      id: 'crypto-wallet-trezor',
      name: 'Ví Trezor',
      description: 'Bảo mật tài sản với Trezor hardware wallet',
      fee: 'Từ $69',
      cta: 'Xem Trezor',
      href: '/go/trezor',
      outboundHref: 'https://trezor.io',
      badge: null,
      icon: '🛡️',
    },
    {
    ...
    },
    {
      ...
      description: 'Quản lý portfolio với CoinStats',
      fee: 'Miễn phí',
      cta: 'Dùng CoinStats',
      href: '/go/coinstats',
      outboundHref: 'https://coinstats.app',
      badge: null,
      icon: '📊',
    },
  ],
...
export const categoryMeta = {
  ...
  crypto: {
    ...
    disclaimer: '* Liên kết giới thiệu (affiliate) — chúng tôi có thể nhận hoa hồng mà không làm tăng chi phí của bạn. Nội dung crypto chỉ mang tính thông tin, không phải tư vấn đầu tư.',
  },
  gold: {
    title: 'Gold Services',
